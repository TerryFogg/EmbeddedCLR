...
if(CONFIG_SUPPORT_GRAPHICS)
    list(APPEND GRAPHICS_SOURCES 
                ${CMAKE_SOURCE_DIR}/src/nanoFramework.Graphics/Graphics/Displays/${DISPLAY_DRIVER}
                ${CMAKE_SOURCE_DIR}/src/nanoFramework.Graphics/Graphics/Interfaces/${DISPLAY_INTERFACE}
    )
endif()
...
if(CONFIG_SUPPORT_GRAPHICSTOUCH)
    ...
    list(APPEND TOUCH_SOURCES
                ...
                ${CMAKE_SOURCE_DIR}/src/nanoFramework.Graphics/TouchPanel/Devices/${TOUCH_INTERFACE_CONTROLLER}
                ${CMAKE_SOURCE_DIR}/src/nanoFramework.Graphics/TouchPanel/Interfaces/${TOUCH_INTERFACE_DRIVER}
    )
endif()
