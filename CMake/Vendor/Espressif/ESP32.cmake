...
set(TARGET_CONFIGURATION_PATH  ${CMAKE_SOURCE_DIR}/targets/Espressif/ESP32P4/Configuration CACHE INTERNAL "Target configuration path")
...
add_custom_target(generate_partition ALL
    ...
    --flash-size 4MB 
    ${CMAKE_SOURCE_DIR}/targets/Espressif/ESP32P4/Configuration/partitions_nanoclr_4mb.csv
...
add_custom_command( TARGET generate_partition POST_BUILD
    COMMAND ${gen_partition_table} 
    --flash-size 8MB 
    ${CMAKE_SOURCE_DIR}/targets/Espressif/ESP32P4/Configuration/partitions_nanoclr_8mb.csv
...
add_custom_command( TARGET generate_partition POST_BUILD
    COMMAND ${gen_partition_table} 
    --flash-size 16MB 
    ${CMAKE_SOURCE_DIR}/targets/Espressif/ESP32P4/Configuration/partitions_nanoclr_16mb.csv
...
add_custom_command( TARGET generate_partition POST_BUILD
    COMMAND ${gen_partition_table} 
    --flash-size 32MB 
    ${CMAKE_SOURCE_DIR}/targets/Espressif/ESP32P4/Configuration/partitions_nanoclr_32mb.csv
